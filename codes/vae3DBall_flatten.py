...
MODEL_PATH = "vae3DBall_flatten.pt"
...
def train(EPOCH):
    ...
    for i, (data, _) in enumerate(train_loader, 0):
        ...
        if i % log_interval == 0:
            ...
            save_image(recon_x.data.view(recon_x.data.size(0), IMG_CHANNEL, 32, 32), RESULT_PATH + str(EPOCH) + '_recon.png')
            save_image(data.data.view(data.size(0), IMG_CHANNEL, 32, 32), RESULT_PATH + str(EPOCH) + '_GT.png')
