...
def train(EPOCH):
    ...
    for i, (data, _) in enumerate(train_loader, 0):
        ...
        if i % log_interval == 0:
            ...
            save_image(recon_x.data.view(BATCH_SIZE, IMG_CHANNEL, 80, 120), RESULT_PATH + str(EPOCH) + '_recon.png')
            save_image(data.data.view(BATCH_SIZE, IMG_CHANNEL, 80, 120), RESULT_PATH + str(EPOCH) + '_GT.png')
